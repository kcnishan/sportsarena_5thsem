    ...
    if(isset($_GET['add'])){
        ...
        if($_POST){
            ...
            if(!empty($errors)){
                ...
                $db->query("INSERT INTO users (full_name,email,password,permissions) VALUES ('$name','$email','$password','$permissions')");
    ...
    <tbody>
        <?php while($user = mysqli_fetch_assoc($userQuery)):?>
            <tr>
                ...
                <td><?=(($user['last_login'] == NULL)?'Never':pretty_date($user['last_login'])); ?></td>
